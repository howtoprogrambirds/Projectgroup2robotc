...
task main()
{
	...
	while (true)
	{
		...
		nxtDisplayCenteredTextLine(1, "RGB: %d", SensorValue[ColorSensor]);  	// display RGB Value
		nxtDisplayCenteredTextLine(2, "Light: %d", SensorValue[LeftSensor]);  	// display Light Value
